...
// Controller = realizar verificação dos dados
// middlewares = funções intermediarias que serão executadas entre a mpsa requisição e as suas ações

const router = express.Router();

//O Request é o que o front-end envia para o backend.
//O Response é o que o backend envia para o frontend
router.post(
  "/",
  //[
